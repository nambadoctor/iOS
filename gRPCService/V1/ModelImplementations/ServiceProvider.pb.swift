...
struct Nd_V1_UserTypeRequest {
  ...
  var phoneNumber: Nd_V1_CustomerPhoneNumber {
    get {return _phoneNumber ?? Nd_V1_CustomerPhoneNumber()}
  ...
  fileprivate var _phoneNumber: Nd_V1_CustomerPhoneNumber? = nil
}
...
struct Nd_V1_ServiceProviderMediaMessage {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Nd_V1_ServiceProviderPrescriptionMessage {
  ...
  var prescriptionImageURL: SwiftProtobuf.Google_Protobuf_StringValue {
    get {return _prescriptionImageURL ?? SwiftProtobuf.Google_Protobuf_StringValue()}
    set {_prescriptionImageURL = newValue}
  }
  /// Returns true if `prescriptionImageURL` has been explicitly set.
  var hasPrescriptionImageURL: Bool {return self._prescriptionImageURL != nil}
  /// Clears the value of `prescriptionImageURL`. Subsequent reads from it will return its default value.
  mutating func clearPrescriptionImageURL() {self._prescriptionImageURL = nil}
  ...
  fileprivate var _customerID: SwiftProtobuf.Google_Protobuf_StringValue? = nil
  fileprivate var _createdDateTime: SwiftProtobuf.Google_Protobuf_Int64Value? = nil
  fileprivate var _prescriptionImageURL: SwiftProtobuf.Google_Protobuf_StringValue? = nil
}
...
struct Nd_V1_ServiceProviderProfileMessage {
  ...
  var availabilities: [Nd_V1_ServiceProviderAvailability] {
...
struct Nd_V1_ServiceProviderServiceRequestMessage {
  ...
  var reason: SwiftProtobuf.Google_Protobuf_StringValue {
    get {return _reason ?? SwiftProtobuf.Google_Protobuf_StringValue()}
  ...
  var examination: SwiftProtobuf.Google_Protobuf_StringValue {
    get {return _examination ?? SwiftProtobuf.Google_Protobuf_StringValue()}
    set {_examination = newValue}
  }
  /// Returns true if `examination` has been explicitly set.
  var hasExamination: Bool {return self._examination != nil}
  /// Clears the value of `examination`. Subsequent reads from it will return its default value.
  mutating func clearExamination() {self._examination = nil}
  ...
  fileprivate var _serviceRequestID: SwiftProtobuf.Google_Protobuf_StringValue? = nil
  fileprivate var _reason: SwiftProtobuf.Google_Protobuf_StringValue? = nil
  fileprivate var _serviceProviderID: SwiftProtobuf.Google_Protobuf_StringValue? = nil
  fileprivate var _appointmentID: SwiftProtobuf.Google_Protobuf_StringValue? = nil
  fileprivate var _examination: SwiftProtobuf.Google_Protobuf_StringValue? = nil
...
extension Nd_V1_UserTypeRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".UserTypeRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "AuthId"),
  ...
  static func ==(lhs: Nd_V1_UserTypeRequest, rhs: Nd_V1_UserTypeRequest) -> Bool {
...
extension Nd_V1_ServiceProviderMediaMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ServiceProviderMediaMessage"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "MediaFile"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._mediaFile) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Nd_V1_ServiceProviderMediaMessage, rhs: Nd_V1_ServiceProviderMediaMessage) -> Bool {
...
extension Nd_V1_ServiceProviderPrescriptionMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .same(proto: "PrescriptionImageUrl"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularMessageField(value: &self._prescriptionImageURL) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if let v = self._prescriptionImageURL {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Nd_V1_ServiceProviderPrescriptionMessage, rhs: Nd_V1_ServiceProviderPrescriptionMessage) -> Bool {
    ...
    if lhs._prescriptionImageURL != rhs._prescriptionImageURL {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Nd_V1_ServiceProviderProfileMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    23: .same(proto: "Availabilities"),
    24: .same(proto: "CreatedDate"),
    25: .same(proto: "LastModifedDate"),
    26: .same(proto: "LatestSlotStartTime"),
    27: .same(proto: "LatestSlotEndTime"),
  ]
  ...
  fileprivate class _StorageClass {
    ...
    var _availabilities: [Nd_V1_ServiceProviderAvailability] = []
    var _createdDate: SwiftProtobuf.Google_Protobuf_Int64Value? = nil
    var _lastModifedDate: SwiftProtobuf.Google_Protobuf_Int64Value? = nil
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 23: try { try decoder.decodeRepeatedMessageField(value: &_storage._availabilities) }()
        case 24: try { try decoder.decodeSingularMessageField(value: &_storage._createdDate) }()
        case 25: try { try decoder.decodeSingularMessageField(value: &_storage._lastModifedDate) }()
        case 26: try { try decoder.decodeSingularMessageField(value: &_storage._latestSlotStartTime) }()
        case 27: try { try decoder.decodeSingularMessageField(value: &_storage._latestSlotEndTime) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if !_storage._availabilities.isEmpty {
        try visitor.visitRepeatedMessageField(value: _storage._availabilities, fieldNumber: 23)
      }
      if let v = _storage._createdDate {
...
extension Nd_V1_ServiceProviderServiceRequestMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularMessageField(value: &self._serviceRequestID) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._reason) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._serviceProviderID) }()
      case 4: try { try decoder.decodeSingularMessageField(value: &self._appointmentID) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._examination) }()
      case 6: try { try decoder.decodeSingularMessageField(value: &self._diagnosis) }()
      case 7: try { try decoder.decodeRepeatedMessageField(value: &self.investigations) }()
      case 8: try { try decoder.decodeSingularMessageField(value: &self._advice) }()
      case 9: try { try decoder.decodeSingularMessageField(value: &self._createdDateTime) }()
      case 10: try { try decoder.decodeSingularMessageField(value: &self._lastModifedDate) }()
      case 11: try { try decoder.decodeSingularMessageField(value: &self._customerID) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.investigations.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.investigations, fieldNumber: 7)
    }
  ...
  static func ==(lhs: Nd_V1_ServiceProviderServiceRequestMessage, rhs: Nd_V1_ServiceProviderServiceRequestMessage) -> Bool {
    ...
    if lhs._serviceProviderID != rhs._serviceProviderID {return false}
    if lhs._appointmentID != rhs._appointmentID {return false}
    if lhs._examination != rhs._examination {return false}
