...
struct Nd_V1_LogInfoMessage {
  ...
  var userType: SwiftProtobuf.Google_Protobuf_StringValue {
    get {return _storage._userType ?? SwiftProtobuf.Google_Protobuf_StringValue()}
  ...
  var eventDateTime: SwiftProtobuf.Google_Protobuf_Int64Value {
    get {return _storage._eventDateTime ?? SwiftProtobuf.Google_Protobuf_Int64Value()}
    set {_uniqueStorage()._eventDateTime = newValue}
  }
  /// Returns true if `eventDateTime` has been explicitly set.
  var hasEventDateTime: Bool {return _storage._eventDateTime != nil}
  /// Clears the value of `eventDateTime`. Subsequent reads from it will return its default value.
  mutating func clearEventDateTime() {_uniqueStorage()._eventDateTime = nil}
  ...
  var sessionID: SwiftProtobuf.Google_Protobuf_StringValue {
    get {return _storage._sessionID ?? SwiftProtobuf.Google_Protobuf_StringValue()}
  ...
  var correlationID: SwiftProtobuf.Google_Protobuf_StringValue {
    get {return _storage._correlationID ?? SwiftProtobuf.Google_Protobuf_StringValue()}
    set {_uniqueStorage()._correlationID = newValue}
  }
  /// Returns true if `correlationID` has been explicitly set.
  var hasCorrelationID: Bool {return _storage._correlationID != nil}
  /// Clears the value of `correlationID`. Subsequent reads from it will return its default value.
  mutating func clearCorrelationID() {_uniqueStorage()._correlationID = nil}

  var appVersion: SwiftProtobuf.Google_Protobuf_StringValue {
    get {return _storage._appVersion ?? SwiftProtobuf.Google_Protobuf_StringValue()}
  ...
  var eventMessage: SwiftProtobuf.Google_Protobuf_StringValue {
    get {return _storage._eventMessage ?? SwiftProtobuf.Google_Protobuf_StringValue()}
    set {_uniqueStorage()._eventMessage = newValue}
  }
  /// Returns true if `eventMessage` has been explicitly set.
  var hasEventMessage: Bool {return _storage._eventMessage != nil}
  /// Clears the value of `eventMessage`. Subsequent reads from it will return its default value.
  mutating func clearEventMessage() {_uniqueStorage()._eventMessage = nil}

  var logLevel: SwiftProtobuf.Google_Protobuf_StringValue {
    get {return _storage._logLevel ?? SwiftProtobuf.Google_Protobuf_StringValue()}
    set {_uniqueStorage()._logLevel = newValue}
  }
  /// Returns true if `logLevel` has been explicitly set.
  var hasLogLevel: Bool {return _storage._logLevel != nil}
  /// Clears the value of `logLevel`. Subsequent reads from it will return its default value.
  mutating func clearLogLevel() {_uniqueStorage()._logLevel = nil}

  var isProduction: SwiftProtobuf.Google_Protobuf_BoolValue {
    get {return _storage._isProduction ?? SwiftProtobuf.Google_Protobuf_BoolValue()}
    set {_uniqueStorage()._isProduction = newValue}
  }
  /// Returns true if `isProduction` has been explicitly set.
  var hasIsProduction: Bool {return _storage._isProduction != nil}
  /// Clears the value of `isProduction`. Subsequent reads from it will return its default value.
  mutating func clearIsProduction() {_uniqueStorage()._isProduction = nil}

  var userDeviceInfo: Nd_V1_DeviceInfoMessage {
    get {return _storage._userDeviceInfo ?? Nd_V1_DeviceInfoMessage()}
    set {_uniqueStorage()._userDeviceInfo = newValue}
  }
  /// Returns true if `userDeviceInfo` has been explicitly set.
  var hasUserDeviceInfo: Bool {return _storage._userDeviceInfo != nil}
  /// Clears the value of `userDeviceInfo`. Subsequent reads from it will return its default value.
  mutating func clearUserDeviceInfo() {_uniqueStorage()._userDeviceInfo = nil}
...
extension Nd_V1_LogInfoMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".LogInfoMessage"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "UserId"),
    2: .same(proto: "UserType"),
    3: .same(proto: "EventDateTime"),
    4: .same(proto: "AppointmentId"),
    5: .same(proto: "SessionId"),
    6: .same(proto: "CorrelationId"),
    7: .same(proto: "AppVersion"),
    8: .same(proto: "EventMessage"),
    9: .same(proto: "LogLevel"),
    10: .same(proto: "IsProduction"),
    11: .same(proto: "UserDeviceInfo"),
  ]

  fileprivate class _StorageClass {
    var _userID: SwiftProtobuf.Google_Protobuf_StringValue? = nil
    var _userType: SwiftProtobuf.Google_Protobuf_StringValue? = nil
    var _eventDateTime: SwiftProtobuf.Google_Protobuf_Int64Value? = nil
    var _appointmentID: SwiftProtobuf.Google_Protobuf_StringValue? = nil
    var _sessionID: SwiftProtobuf.Google_Protobuf_StringValue? = nil
    var _correlationID: SwiftProtobuf.Google_Protobuf_StringValue? = nil
    var _appVersion: SwiftProtobuf.Google_Protobuf_StringValue? = nil
    var _eventMessage: SwiftProtobuf.Google_Protobuf_StringValue? = nil
    var _logLevel: SwiftProtobuf.Google_Protobuf_StringValue? = nil
    var _isProduction: SwiftProtobuf.Google_Protobuf_BoolValue? = nil
    var _userDeviceInfo: Nd_V1_DeviceInfoMessage? = nil
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._userType) }()
        case 3: try { try decoder.decodeSingularMessageField(value: &_storage._eventDateTime) }()
        case 4: try { try decoder.decodeSingularMessageField(value: &_storage._appointmentID) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._sessionID) }()
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._correlationID) }()
        case 7: try { try decoder.decodeSingularMessageField(value: &_storage._appVersion) }()
        case 8: try { try decoder.decodeSingularMessageField(value: &_storage._eventMessage) }()
        case 9: try { try decoder.decodeSingularMessageField(value: &_storage._logLevel) }()
        case 10: try { try decoder.decodeSingularMessageField(value: &_storage._isProduction) }()
        case 11: try { try decoder.decodeSingularMessageField(value: &_storage._userDeviceInfo) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._userType {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      }
      if let v = _storage._eventDateTime {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
      }
      ...
      if let v = _storage._correlationID {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
      }
      if let v = _storage._appVersion {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 7)
      }
      if let v = _storage._eventMessage {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 8)
      }
      if let v = _storage._logLevel {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 9)
      }
      if let v = _storage._isProduction {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
      }
      if let v = _storage._userDeviceInfo {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 11)
      }
    }
    try unknownFields.traverse(visitor: &visitor)
  ...
  static func ==(lhs: Nd_V1_LogInfoMessage, rhs: Nd_V1_LogInfoMessage) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._eventDateTime != rhs_storage._eventDateTime {return false}
        ...
        if _storage._eventMessage != rhs_storage._eventMessage {return false}
        if _storage._logLevel != rhs_storage._logLevel {return false}
        if _storage._isProduction != rhs_storage._isProduction {return false}
        if _storage._userDeviceInfo != rhs_storage._userDeviceInfo {return false}
        return true
      }
