...
internal protocol Nd_V1_ServiceProviderPrescriptionWorkerV1ClientInterceptorFactoryProtocol {
  ...
  func makeDownloadPrescriptionMediaInterceptors() -> [ClientInterceptor<Nd_V1_IdMessage, Nd_V1_ServiceProviderMediaMessage>]
}
...
internal protocol Nd_V1_ServiceProviderPrescriptionWorkerV1Provider: CallHandlerProvider {
  ...
  func downloadPrescriptionMedia(request: Nd_V1_IdMessage, context: StatusOnlyCallContext) -> EventLoopFuture<Nd_V1_ServiceProviderMediaMessage>
}
...
internal protocol Nd_V1_ServiceProviderPrescriptionWorkerV1ServerInterceptorFactoryProtocol {
  ...
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeDownloadPrescriptionMediaInterceptors() -> [ServerInterceptor<Nd_V1_IdMessage, Nd_V1_ServiceProviderMediaMessage>]
}
/// To build a server, implement a class that conforms to this protocol.
