...
internal protocol Nd_V1_UserTypeWorkerV1ClientProtocol: GRPCClient {
  ...
  func getUserType(
    _ request: Nd_V1_UserTypeRequest,
    callOptions: CallOptions?
  ) -> UnaryCall<Nd_V1_UserTypeRequest, Nd_V1_StringMessage>
}
...
internal protocol Nd_V1_UserTypeWorkerV1ClientInterceptorFactoryProtocol {
  ...
  func makeGetUserTypeInterceptors() -> [ClientInterceptor<Nd_V1_UserTypeRequest, Nd_V1_StringMessage>]
}
...
internal protocol Nd_V1_ServiceProviderReportWorkerV1ClientProtocol: GRPCClient {
  ...
  func downloadReportMedia(
    _ request: Nd_V1_IdMessage,
    callOptions: CallOptions?
  ) -> UnaryCall<Nd_V1_IdMessage, Nd_V1_ServiceProviderMediaMessage>
}
...
internal protocol Nd_V1_ServiceProviderReportWorkerV1ClientInterceptorFactoryProtocol {
  ...
  func makeDownloadReportMediaInterceptors() -> [ClientInterceptor<Nd_V1_IdMessage, Nd_V1_ServiceProviderMediaMessage>]
}
...
internal protocol Nd_V1_UserTypeWorkerV1Provider: CallHandlerProvider {
  ...
  func getUserType(request: Nd_V1_UserTypeRequest, context: StatusOnlyCallContext) -> EventLoopFuture<Nd_V1_StringMessage>
}
...
extension Nd_V1_UserTypeWorkerV1Provider {
  ...
  internal func handle(
    ...
    case "GetUserType":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Nd_V1_UserTypeRequest>(),
        responseSerializer: ProtobufSerializer<Nd_V1_StringMessage>(),
        interceptors: self.interceptors?.makeGetUserTypeInterceptors() ?? [],
...
internal protocol Nd_V1_UserTypeWorkerV1ServerInterceptorFactoryProtocol {
  ...
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeGetUserTypeInterceptors() -> [ServerInterceptor<Nd_V1_UserTypeRequest, Nd_V1_StringMessage>]
}
/// To build a server, implement a class that conforms to this protocol.
...
internal protocol Nd_V1_ServiceProviderReportWorkerV1Provider: CallHandlerProvider {
  ...
  func downloadReportMedia(request: Nd_V1_IdMessage, context: StatusOnlyCallContext) -> EventLoopFuture<Nd_V1_ServiceProviderMediaMessage>
}
  ...
  internal func handle(
    ...
    case "DownloadReportMedia":
      return UnaryServerHandler(
        context: context,
        requestDeserializer: ProtobufDeserializer<Nd_V1_IdMessage>(),
        responseSerializer: ProtobufSerializer<Nd_V1_ServiceProviderMediaMessage>(),
        interceptors: self.interceptors?.makeDownloadReportMediaInterceptors() ?? [],
...
internal protocol Nd_V1_ServiceProviderReportWorkerV1ServerInterceptorFactoryProtocol {
  ...
  ///   Defaults to calling `self.makeInterceptors()`.
  func makeDownloadReportMediaInterceptors() -> [ServerInterceptor<Nd_V1_IdMessage, Nd_V1_ServiceProviderMediaMessage>]
}
/// To build a server, implement a class that conforms to this protocol.
