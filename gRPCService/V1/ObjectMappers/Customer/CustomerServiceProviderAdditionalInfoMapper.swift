...
class CustomerServiceProviderAdditionalInfoMapper {
    static func grpcToLocal (additionalInfo:Nd_V1_CustomerServiceProviderAdditionalInfoMessage) -> CustomerServiceProviderAdditionalInfo {
        return CustomerServiceProviderAdditionalInfo(Symptoms: additionalInfo.symptoms.convert(),
    ...
    static func localToGrpc (additionalInfo:CustomerServiceProviderAdditionalInfo) -> Nd_V1_CustomerServiceProviderAdditionalInfoMessage {
        return Nd_V1_CustomerServiceProviderAdditionalInfoMessage.with {
